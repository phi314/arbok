...
<head>
<?php
$sql_tahun_ajaran = "SELECT * FROM tahun_ajaran WHERE id_tahun_ajaran='$id_tahun_ajaran'";
$hasil_tahun_ajaran = mysql_query($sql_tahun_ajaran); 
if($hasil_tahun_ajaran)
{
 while($data_tahun_ajaran = mysql_fetch_array($hasil_tahun_ajaran))
 {
  $id_tahun_ajaran = $data_tahun_ajaran['id_tahun_ajaran'];
 ...
 <div class="span12"><!--PANJANG TABEL-->
  <div class="portlet box blue"> <!--WARNA TABEL-->
   <div class="portlet-title">
    <h4><i class="icon-edit"></i> PENGUBAHAN INFORMASI TAHUN AJARAN</h4>
...
<form method="post" action="th_ajaran_ubah.php" enctype="multipart/form-data" class="form-horizontal">
<div class="control-group"><label class="control-label">Nama Tahun Ajaran</label>
<div class="controls">
<input type="text" name="nama_tahun_ajaran" value="<?php echo @$nama_tahun_ajaran?>" class="m-wrap large" />
<input type="hidden" name="id_tahun_ajaran" value="<?php echo @$id_tahun_ajaran?>" class="m-wrap large" />
</div></div>
<div class="form-actions">
 ...
 if(@$_POST["Ubah"]=="Ubah")
 {
  ...
  if($sql)
  {
   ?>
   <script language="JavaScript">
   alert('Informasi Tahun Ajaran Dirubah');
