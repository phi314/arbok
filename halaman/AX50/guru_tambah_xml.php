 ...
 <div class="span12"><!--PANJANG TABEL-->
  <div class="portlet box blue"> <!--WARNA TABEL-->
   <div class="portlet-title">
    <h4><i class="icon-edit"></i> PENAMBAHAN PENGAJAR DARI MS.EXCEL</h4>
...
<form method="post" action="guru_tambah_xml_proses.php" enctype="multipart/form-data" class="form-horizontal">
