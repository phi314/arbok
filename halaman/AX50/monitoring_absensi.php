               ...
               <div class="span9">
                   <?php
                        ...
                        $q_jumlah_absensi = mysql_query("SELECT absensi_detail.id,  absensi_detail.absen
                                                    ...
                                                    AND kelas.tingkat = '$kelas'") or die(mysql_error());
                   ...
                   ?>
                   <h3><?php echo "Tingkat: ".$kelas."<br>Bulan: ".getBulan($bulan)."<br>Tahun: ".$tahun; ?></h3>
                    ...
                    <div class="row-fluid">
                        <div class="span12">
                            <?php
                            $q_siswa = mysql_query("SELECT nis, nama_siswa, nama_kelas FROM siswa JOIN kelas ON kelas.id_kelas=siswa.id_kelas WHERE kelas.tingkat='$kelas'") or die(mysql_error());
                            ?>
