...
function pengguna()
{
 ...
 <li class="dropdown user">
  ...
  <ul class="dropdown-menu">
   <li><a href="D255/profil.php?nip=<?php echo $nip; ?>"><i class="icon-user"></i> Profil</a></li>
 ...
 <div class="page-sidebar nav-collapse collapse">
  <ul>
   ...
   <li class="has-sub "><a href="javascript:;"><i class="icon-user"></i><span class="title">Profil</span><span class="arrow"></span></a>
    <ul class="sub">
     <li><a href="D255/profil.php?nip=<?php echo $nip; ?>">Lihat Profil</a></li>
     <li><a href="D255/profil_ubah.php?nip=<?php echo $nip; ?>">Ubah Profil</a></li>
     <li><a href="D255/profil_ubah_password.php?nip=<?php echo $nip; ?>">Ubah Password</a></li>
    </ul>
   </li>
   <li class=""><a href="D255/materi.php"><i class="icon-bookmark-empty"></i><span class="title">Pengolahan Materi</span></a></li>
   <li class=""><a href="D255/soal.php"><i class="icon-table"></i><span class="title">Pengolahan Soal</span></a></li>
   <li class=""><a href="D255/to.php"><i class="icon-briefcase"></i><span class="title">Pengolahan Try Out</span></a></li>
   <li class="has-sub "><a href="javascript:;"><i class="icon-bar-chart"></i><span class="title">Pengolahan Nilai</span><span class="arrow"></span></a>
    <ul class="sub">
     <li><a href="D255/nilai_tambah.php">Tambah Nilai</a></li>
     <li><a href="D255/nilai.php">Lihat Nilai</a></li>
    </ul>
   </li>
   <li class="has-sub "><a href="javascript:;"><i class="icon-th-list"></i><span class="title">Analisis Butir Soal</span><span class="arrow"></span></a>
    <ul class="sub">
     <li><a href="D255/analisis_m1.php">Tingkat Kesukaran Soal</a></li>
     <li><a href="D255/analisis_m2.php">Daya Pembeda Soal</a></li>
    </ul>
   </li>
   <li class=""><a href="D255/gallery.php?nip=<?php echo $nip; ?>"><i class="icon-camera"></i><span class="title">Gallery</span></a></li>
      <li class=""><a href="D255/monitoring_absensi.php"><i class="icon-table"></i><span class="title">Monitoring Absensi</span></a></li>
  </ul>
 </div>
 <?php
}
