...
function menu_utama()
{
 ...
 <div class="page-sidebar nav-collapse collapse">
  <ul>
   ...
   <li class=""><a href="AX50/pelajaran.php"><i class="icon-table"></i><span class="title">Pengolahan Pelajaran</span></a></li>
   <li class=""><a href="AX50/guru.php"><i class="icon-table"></i><span class="title">Pengolahan Pengajar</span></a></li>
