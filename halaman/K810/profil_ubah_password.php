...
<div class="row-fluid ">
 <div class="span4"><!--PANJANG TABEL-->
  ...
  <div class="portlet box blue tabbable"> <!--WARNA TABEL-->
   <div class="portlet-title">
    <h4><i class="icon-reorder"></i> PENGUBAHAN PASSWORD PENGGUNA</h4>
	<!--AWAL KONFIGURASI TAMBAHAN KONTEN
    AKHIR KONFIGURASI TAMBAHAN KONTEN-->
   </div>
   <div class="portlet-body">
...
<tr><td><b>PASSWORD BARU</b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<td>
								 <input type="password" name="password" placeholder="Inputkan Password Baru Anda">
							     ...
							     <input type="hidden" name="email" value="<?php echo @$email; ?>"></td></tr>
