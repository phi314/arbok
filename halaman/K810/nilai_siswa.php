<?php
  ...
  $sql_kelas = "SELECT * FROM mp WHERE id_mp='$id_mp'";
  $result_kelas = mysql_query($sql_kelas);
  $data_kelas = mysql_fetch_object($result_kelas);
  
  if( mysql_num_rows($result_kelas) ):
    $nama_mp = $data_kelas->nama_mp;
  endif;
 ...
 <div class="span12"><!--PANJANG TABEL-->
  <div class="portlet box blue"> <!--WARNA TABEL-->
   ...
   <div class="portlet-body">
    ...
    <a href="nilai_semester_ganjil.php?nis=<?php echo $nis; ?>&id_kelas=<?php echo $id_kelas; ?>&id_mp=<?php echo $id_mp; ?>" class="btn btn-success">Nilai Semester Ganjil</a>
    <a href="nilai_semester_genap.php?nis=<?php echo $nis; ?>&id_kelas=<?php echo $id_kelas; ?>&id_mp=<?php echo $id_mp; ?>" class="btn btn-success">Nilai Semester Genap</a>
