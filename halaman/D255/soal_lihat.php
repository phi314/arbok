<?php
  ...
  $sql_soal = "SELECT * FROM soal JOIN mp USING (id_mp) WHERE id_mp='$id_mp' ORDER BY soal.penyusun ASC";
 ...
 <div class="span12"><!--PANJANG TABEL-->
  <div class="portlet box blue"> <!--WARNA TABEL-->
   <div class="portlet-title">
    <h4><i class="icon-edit"></i> LISTING KESELURUHAN SOAL <?php echo $nama_mp; ?></h4>
   ...
   <div class="portlet-body">
    <div class="clearfix">
     <div class="btn-group">
      <a href="soal.php"><button class="btn red">Kembali</button></a>
     </div>
    </div>
...
if($jmldata_soal > 0)
{
 while($data_soal = mysql_fetch_object($result_soal))
 {
  ...
  <tr class="">
   ...
   <td><center><?php echo $data_soal -> penyusun; ?></center></td>
  </tr>
  <?php
 }
}
