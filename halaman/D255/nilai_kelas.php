 ...
 <div class="span12"><!--PANJANG TABEL-->
  <div class="portlet box blue"> <!--WARNA TABEL-->
   <div class="portlet-title">
    <h4><i class="icon-edit"></i> LIHAT NILAI -> DAFTAR KELAS -> DAFTAR SISWA KELAS <?php echo $data_kelas -> nama_kelas; ?></h4>
...
if($jmldata_siswa > 0)
{
 while($data_siswa = mysql_fetch_object($result_siswa))
 {
  ...
  <tr class="">
   ...
   <td><center><a href="nilai_siswa.php?nis=<?php echo $data_siswa -> nis; ?>&id_kelas=<?php echo $id_kelas; ?>">Pilih Siswa</a></center></td>
   </tr>
  <?php
 }
}
