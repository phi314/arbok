...
function pengguna()
{
 ...
 <li class="dropdown user">
  ...
  <ul class="dropdown-menu">
   <li><a href="K810/profil.php?nis=<?php echo $nis; ?>"><i class="icon-user"></i> Profil</a></li>
 ...
 <div class="page-sidebar nav-collapse collapse">
  <ul>
   ...
   <li class="has-sub "><a href="javascript:;"><i class="icon-user"></i><span class="title">Profil</span><span class="arrow"></span></a>
    <ul class="sub">
     <li><a href="K810/profil.php?nis=<?php echo $nis; ?>">Lihat Profil</a></li>
     <li><a href="K810/profil_ubah.php?nis=<?php echo $nis; ?>">Ubah Profil</a></li>
     <li><a href="K810/profil_ubah_password.php?nis=<?php echo $nis; ?>">Ubah Password</a></li>
    </ul>
   </li>
   <li class=""><a href="K810/to.php"><i class="icon-briefcase"></i><span class="title">Pelaksanaan Try Out</span></a></li>
   <li class=""><a href="K810/nilai.php"><i class="icon-bar-chart"></i><span class="title">Informasi Nilai</span></a></li>
   <li class=""><a href="K810/gallery.php?nis=<?php echo $nis; ?>"><i class="icon-camera"></i><span class="title">Gallery</span></a></li>
  </ul>
 </div>
 <?php
}
