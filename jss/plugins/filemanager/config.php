...
$upload_dir = '/sman24/HAL/GRU/soal/'; // path from base_url to upload base dir
$current_path = '../../../HAL/GRU/soal/'; // relative path from filemanager folder to upload files folder
